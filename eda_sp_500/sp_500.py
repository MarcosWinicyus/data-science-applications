...
from altair.vegalite.v4.schema.core import Color, FontWeight, Header
...
def view():
    ...
    st.markdown(""""
    This app retrives the list of the **S&P 500** (from wikipedia) and its corresponding stock closing price(year-to-date)!
    ...
    * **Data source:** [Wikipedia](https://en.wikipedia.org/wiki/List_of_S%26P_500_companies)
    ...
    # Web scraping of S&P500 player stats
