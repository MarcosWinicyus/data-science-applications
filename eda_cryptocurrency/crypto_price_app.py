...
def view():
    ...
    # image = Image.open('/personal/study/streamlit/eda_cryptocurrency/logo.jpeg')
    ...
    * **Credit:** Web scraper adapted from the Medium article *[Web Scraping Crypto Prices With Python](https://towardsdatascience.com/web-scraping-crypto-prices-with-python-41072ea5b5bf)* written by [Bryan Feng](https://medium.com/@bryanf).
    ...
    def load_data():
        ...
        df = pd.DataFrame(columns=['coin_name', 'coin_symbol', 'marketCap', 'percentChange1h','percentChange24h', 'percentChange7d', 'price', 'volume_24h'])
    ...
    if percent_timeframe == '7d':
        ...
        df_change['percentChange7d'].plot(kind='barh', color=df_change.positivePercentChange7d.map({True: 'g', False: 'r'}))
        col3.pyplot(plt)
        ...
        plt.figure(figsize=(5,25))
        plt.subplots_adjust(top = 1, bottom = 0)
        df_change['percentChange24h'].plot(kind='barh', color=df_change.positivePercentChange24h.map({True: 'g', False: 'r'}))
        col3.pyplot(plt)
    else:
        if sort_values == 'Yes':
        ...
        plt.figure(figsize=(5,25))
        plt.subplots_adjust(top = 1, bottom = 0)
        df_change['percentChange1h'].plot(kind='barh', color=df_change.positivePercentChange1h.map({True: 'g', False: 'r'}))
        col3.pyplot(plt)
